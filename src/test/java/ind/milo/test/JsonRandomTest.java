...
public class JsonRandomTest {
    ...
    public static void main(String[] args) {
        System.out.println("========== JSON 随机值功能测试 ==========\n");
        
        // 测试用例 1: 对象数组（value 随机生成）
        String input1 = "user[{name,age,id}]";
        System.out.println("【对象数组 - 随机值】输入：" + input1);
        ...
        // 测试用例 2: 简单键值对（不随机）
        String input2 = "a, b, 100";
        System.out.println("【简单键值对 - 不随机】输入：" + input2);
        System.out.println("输出:");
        System.out.println(parseToJson(input2));
        System.out.println();
        
        // 测试用例 3: 字符串数组（不随机）
        String input3 = "data[x,y,z]";
        System.out.println("【字符串数组 - 不随机】输入：" + input3);
        System.out.println("输出:");
        System.out.println(parseToJson(input3));
        System.out.println();
        
        // 测试用例 4: 混合场景
        String input4 = "title, count, items[{id,name,price}]";
        System.out.println("【混合场景】输入：" + input4);
        System.out.println("输出 1:");
